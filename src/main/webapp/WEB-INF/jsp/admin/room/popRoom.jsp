...
<div class="div-userform">
	<div class="modal-header">
		<h5 class="modal-title" id="exampleModalLongTitle">회의실사진 업로드</h5>
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-primary btn-save-room">
			<i class="far fa-check-circle"></i>저장
		</button>
		<button type="button" class="btn btn-default btn-close-room" data-type='popRoom'>
...
var myDropzone = new Dropzone("div#file-dropzone", { 
        ...
        url: "/admin/flrPlnUpload?locSeq=" + tableData.locSeq + "&flrPlanYn=N&roomSeq="+tableData.roomSeq+"&ord="+$("#ord").val() , // 드롭다운 시 업로드 되는 URL
...
//팝업닫기버튼
$('.btn-close-room').on('click', function(){
	popObj = $(this);
	$('#popModal').modal('hide');
});
