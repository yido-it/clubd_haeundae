...
<div class="div-userform">
	<div class="modal-header">
		<h5 class="modal-title" id="exampleModalLongTitle">평면도 업로드</h5>
	...
	<div class="modal-footer">
		<button type="button" class="btn btn-primary btn-save-flrPln">
			<i class="far fa-check-circle"></i>저장
		</button>
		<button type="button" class="btn btn-default btn-close-flrPln">
...
var myDropzone = new Dropzone("div#file-dropzone", { 
        ...
        url: "/admin/flrPlnUpload?locSeq=" + tableData.locSeq + "&flrPlanYn=Y&roomSeq=0" , // 드롭다운 시 업로드 되는 URL
...
//이미지 업로드
$('.btn-save-flrPln').on('click', function(){
	myDropzone.processQueue();
});

//팝업닫기버튼
$('.btn-close-flrPln').on('click', function(){
	$('#popModal').modal('hide');
});
