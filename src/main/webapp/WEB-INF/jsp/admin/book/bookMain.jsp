	...
	<div class="container-fluid page-body-wrapper">
		...
		<div class="main-panel">
			<div class="content-wrapper">
					...
					<div class="col-md-6 grid-margin-sm-0">
						<div class="row">
							<div class="col-12 col-xl-8 mb-4 mb-xl-0">
								<h5 class="font-weight-bold">예약리스트</h5>
							</div>
						</div>
					</div>
					<div class="col-md-6 grid-margin-sm-0" style="text-align:right">
						<div class="row">
							<div class="col-12 col-xl-12 mb-12 mb-xl-0">
								<span class="menuRoute">예약관리 > 예약리스트</span>
							</div>
						</div>
					</div>
				</div>

				<div class="card card-margin" style="width:68%;float:left">		
					<!-- 조회 -->
					<div class="row">	
						<!-- 일자 -->					
						<div class="col-lg-4 col-xl-4">
							<div class="form-group row">
								...
								<div class="col-xl-9">
									<input type="text" class="form-control form-control-sm searchBookDt" id="searchBookDt" name="searchBookDt"/>
								</div>
							</div>
						</div>			
						<!-- 지점 -->					
						...
						<div class="col-lg-4 col-xl-4">
							<div class="form-group row">
								<div class="col-6">
							 		<button type="button" class="btn btn-inverse-primary btn-fw download-csv" style="width:100%">엑셀다운로드</button>
							  	 </div>
							</div>				
						</div>-->		
					</div>
				...
				<div class="card" style="padding:10px;margin:20px 0 0 10px;width:30%;float:left">
					<!-- 예약자정보 -->
...
var table = new Tabulator("#tabList", {
	...
	columns : [
		 { title:"예약시작일자", field:"bookStrtDt", sorter:"string", headerHozAlign:"center", hozAlign:"center", headerFilter:"input", minWidth:120} 
		,{ title:"예약종료일자", field:"bookEndDt", sorter:"string", headerHozAlign:"center", hozAlign:"center", headerFilter:"input", minWidth:120} 
		...
		,{ title:"결제금액", field:"payAmt", sorter: "integer", headerHozAlign:"center", hozAlign:"center", headerFilter:"input"
			, formatter:"money", formatterParams:{thousand:",", symbol:"원", symbolAfter:"p", precision:false}}
	    ,{ title:"변경", field:"modify", formatter: editIcon, headerHozAlign:"center", hozAlign:"center", headerSort:false,
			cellClick:function(e, cell){
				var bookCd = cell._cell.row.data.bookCd;
		    	location.href = '/admin/book/detail?bookCd=' + bookCd; }}
	] 
	, locale:true
	, langs:{
...
table.on("rowClick", function(e, row){
	...
	fnDetailSearch(row._row.data.bookCd, row._row.data.bookSttsCd);
    ...
    $.ajax({
        ...
        success: function(data) {
        	document.querySelector("#email").innerHTML = "- 이메일: " + data[0].email;
        	document.querySelector("#tel").innerHTML = "- 연락처: " + data[0].tel;
...
// 상세 목록 조회 
function fnDetailSearch(bookCd, bookSttsCd){

	var url = "";
	
	if (bookSttsCd == '100004') {
		url = '/admin/bkDetailLog/groupByList';
	} else {
		url = '/admin/bkDetail/status';
	}
