          ...
          <div class="col-sm-12">
             ...
             <div class="swiper-wrapper">
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main.jpg" alt=""> 
                 <div class="text_position"><p>MUSIC LOUNGE</p></div>
               </div>
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main2.jpg" /> 
                 <div class="text_position"><p>SWITCH HALL</p></div>
               </div>
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main3.jpg" /> 
                 <div class="text_position"><p>회의실 M1</p></div>
               </div>
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main4.jpg" /> 
                 <div class="text_position"><p>회의실 M2</p></div>
               </div>
               <div class="swiper-slide">
                <img src="/img/location/yeouido/main1.jpg" /> 
                <div class="text_position"><p>회의실 M2</p></div>
              </div>
             ...
             <div class="swiper-wrapper">
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main.jpg" />
               </div>
               <div class="swiper-slide">
                 <img src="/img/location/yeouido/main2.jpg" />
               </div>
            ...
            <!-- <div id="property-single-carousel" class="owl-carousel owl-arrow gallery-property">
              ...
              <div class="carousel-item-b">
                <img src="/img/location/yeouido/main2.jpg" alt="">
              </div>
              <div class="carousel-item-b">
                <img src="/img/location/yeouido/main3.jpg" alt="">
              </div>
              <div class="carousel-item-b">
                <img src="/img/location/yeouido/main4.jpg" alt="">
              </div>
            </div> -->
            <!--//슬라이드-->
			...
			<i class="fa-solid fa-arrow-right" aria-hidden="true"></i>
              ...
              <div class="col-md-7 col-lg-7 section-md-t3">
                <div class="row"> 
                <img style="width:300px" src="/img/location/yeouido/logo_yeouido.png" />  
                </div>
                <div class="row">
                  <div class="col-sm-12">
                ...
                <div class="property-description">
                  <p class="description color-text-a">
                    오피스 라이프 스타일을 위한 다양한 컨텐츠가 한 곳에,<br/>

                    모임과 업무를 위한 카페와 미팅존, <br/>
                    
                    힐링을 위한 릴렉스존,<br/>
                    
                    오피스라이프를 완성하는 VIP 공간까지 모두 만날 수 있는 <br/>
                  ...
                  <p class="description color-text-a no-margin"> 
                    <i class="fa-solid fa-clock iconborder"></i> 07:30 AM ~ 18:00 PM
                    <br/> <br/>
                    <i class="fa-solid fa-phone iconborder"></i> 02-3458-4080
                  </p>
                </div>
...
<!--뮤직라운지-->
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/1-0.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            ...
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="" data-toggle="modal" data-target=".bs-example-modal-lg">MUSIC LOUNGE 
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">MUSIC LOUNGE </h4>
        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
          ...
          <div class="carousel-inner object_image">
            <div class="carousel-item active">
              <img class="d-block w-100" src="/img/location/yeouido/1-1.jpg" alt="First slide">
            </div>
  ...
  <div class="row">
   <div class="col-12 mt-2">
        <h4 class="mt-2">뮤직 라운지</h4>
   <p> 하이앤드 오디오 시스템에서 나오는 음악을 배경으로 특급호텔의 라운지보다 더 좋은 공간에서

실력 있는 바리스타가 제공하는 스페셜티 커피와 음료를 즐기실 수 있습니다. </p>
 
       <h4 class="mt-2"> 시설안내</h4>
        <p>세미나실1+2은 최대 100명까지 수용 가능한 룸으로, 세미나룸1과 2를 이어 이용합니다.
        탁 트인 공간에서 세미나 및 컨퍼런스 등 대형 모임을 진행할 수 있습니다.
        <br/><br/>
        스쿨식 100명(최소 80명~최대 100명)
        <br/><br/>
        ○ 기준 인원 : 스쿨식 100명(최소 80명 ~ 최대 100명)<br/>
        ○ 구비 품목 : 빔 프로젝터, 전동 스크린, 벽면 글라스보드, 연설대<br/>
        ○ 대여 가능 품목 : 앰프(마이크), 마이크 스탠드, 레이저 포인터
      </p>
    </div>
  </div>
...
<!-- //팝업 modal -->
                    ...
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/2-1.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            <div class="card-category-b">
                              <a href="#" class="category-b">컨퍼런스홀</a>
                            </div>
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="blog-single.html"> SWITCH HALL
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
                    ...
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/3-1.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            <div class="card-category-b">
                            ...
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="blog-single.html">회의실 M1
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
                    ...
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/4-1.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            <div class="card-category-b">
                            ...
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="blog-single.html">회의실 M2
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
                    ...
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/5-1.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            <div class="card-category-b">
                            ...
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="blog-single.html">회의실 M3
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
                    ...
                    <div class="col-md-4">
                      <div class="card-box-b card-shadow news-box">
                        <div class="img-box-b">
                          <img src="/img/location/yeouido/6-1.jpg" alt="" class="img-b img-fluid">
                        </div>
                        <div class="card-overlay">
                          <div class="card-header-b">
                            <div class="card-category-b">
                            ...
                            <div class="card-title-b">
                              <h2 class="title-2">
                                <a href="blog-single.html">회의실 M4+M5
                                  <br>  </a>
                              </h2>
                            </div>
                            <div class="card-date">
...
<!--탭 오시는길 평면도-->
              ...
              <div class="col-md-12  load_yeouido" >
                <ul class="nav nav-pills-a nav-pills mb-3 section-t3" id="pills-tab" role="tablist">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" id="pills-video-tab" data-toggle="pill" href="#pills-video" role="tab" aria-controls="pills-video" aria-selected="true">영상</a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <div class="tab-pane fade" id="pills-plans" role="tabpanel" aria-labelledby="pills-plans-tab">
                    <img src="/img/location/yeouido/floor.png" alt="" class="img-fluid">
                  </div> 
                  <!--요금-->
